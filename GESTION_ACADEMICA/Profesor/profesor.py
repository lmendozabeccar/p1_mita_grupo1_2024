...
def profesores(matriz_legajos_notas):
    flag_profes = True
    ...
    while flag_profes == True:
        ...
        if respuesta_prof == 1:
            ...
            if matriz_legajos_notas == {}:
                ...
                matriz_notas_actualizadas = actualizar_notas_alumno (matriz_legajos_notas) #Puede cambiar las notas de un alumno YA EXISTENTE.
            
        elif respuesta_prof == 4:
            matriz_notas_actualizadas = eliminar_alumno (matriz_legajos_notas) #Elimina alumnos 
